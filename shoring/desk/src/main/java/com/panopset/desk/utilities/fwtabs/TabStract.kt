...
class TabStract {
    ...
    fun createTab(fxDoc: FxDoc): Tab {
        ...
        stractGoButton = createPanButton({
        ...
        bp.top = createPanFlowPane(
            ...
            createPanButton({stractSrc.text = ""}, "Clear _input",true, "Clear the input text area."),
            createPanButton({stractOut.text = ""}, "Clear _output", true, "Clear the output text area.")
        )
