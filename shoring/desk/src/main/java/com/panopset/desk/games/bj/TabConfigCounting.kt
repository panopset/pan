    ...
    fun createTab(ctls: BlackjackFxControls): Tab {
        ...
        val topHbox = createPanHBox(
            createPanVBox(
                ...
                createPanFlowPane(
                    createPanButton({userReset(ctls)}, "Reset to default.", false, ""),
        ...
        ctls.cbCountingSystems.selectionModel.selectedIndexProperty()
            .addListener { _, _, newIndex ->
                Thread { // TODO: Replace Thread.
                    ...
                    Logop.info(String.format("Counting systems updated to %s.", countingSystems.findSelected().name))
                }.start()
            }
...
val defaultCountingSystems = DefaultResources.defaultCountingSystems
