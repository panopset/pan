...
class Scrambler : PanopsetBrandedAppTran() {
    ...
    override fun createDynapane(fxDoc: FxDoc): Pane {
        unscrambleButton = createPanButton({doUnscramble()}, "_Unscramble", true, "Unscramble the given text, using the given password.")
        scrambleButton = createPanButton({doScramble()}, "_Scramble", true, "Scramble the given text, using the given password.")
