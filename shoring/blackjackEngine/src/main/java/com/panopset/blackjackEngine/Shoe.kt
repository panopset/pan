...
class Shoe(val numberOfDecks: Int) {
    ...
    fun stackTheDeckFromDeckStacker(deckStacker: DeckStacker) {
        stackTheDeckFromEOLseparatedText(deckStacker.stackedDeck)
    }

    fun stackTheDeckFromEOLseparatedText(stackedDeck: String) {
